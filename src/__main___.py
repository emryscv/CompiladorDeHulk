...
# #print(derivation)
derivation = parser([protocol, id, ocurl, id, opar, id, colon, id, cpar, colon, id, semicolon, ccurl, let, id, colon, id, asign_equal, num, in_token, if_token, opar, id, equal, num, cpar, id, double_at, id, dot, id, opar, cpar, else_token, id, semicolon, G.EOF])
